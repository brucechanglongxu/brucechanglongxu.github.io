...
Let $$a = (|z_1| + ... + |z_{2019}|)/2019$$ be the average of the distances from $$z_1, ..., z_{2019}$$ to the origin. Determine the largest constant $$M$$ such that $$a \ge M$$ for all choices of $$b_0, b_1, ..., b_{2019}$$ that satisfy:
