...
the issue with this approach is that it commits early to a single path, even if later steps make it incorrect, and it fails in reasoning tasks, where earlier mistakes compound into incorrect conclusions
