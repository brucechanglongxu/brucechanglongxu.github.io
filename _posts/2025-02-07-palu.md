...
All of these existing methods neglect hidden dimension redundancy in KV tensors. Palu compresses the hidden dimension itself, complementing quantiazation and token eviction techniques. 