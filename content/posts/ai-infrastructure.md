...
Now some precuror solutions to the ZeRO methodology are well-published, widely used techniques such as mixed precision training, data parallelism, pipeline parallelism (Gpipe, zerobubble), tensor parallelism () and sharding. 
