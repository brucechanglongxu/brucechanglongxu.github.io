...
| **Area**                  | **Decoder-only (GPT-style)**                                                            | **Encoder–decoder (T5/BART/UL2-style)**                                                                     |
| ------------------------- | --------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------- |
...
| **Long context**          | Mature: FlashAttention, GQA/MQA, 128k+ windows, rolling caches.                         | Works, but you pay encode cost proportional to input length whenever it changes.                            |
...
| **Tool use / multi-turn** | Natural; append tool outputs, keep rolling.                                             | Fine, but recompute encoder context as tools add evidence.                                                  |
