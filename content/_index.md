...
$$
\mathrm{BI} = \frac{1}{K}\sum_{k=1}^K = \mathbf{1} \left[ \mathbb{E}_{e \sim \mathcal{T}_k}[U(\pi^*, e)] \ge (1 + \delta) \mathrm{max}_{x \in \Pi_{H}} \mathbb{E}_{e \sim \mathcal{T}_k}[U(\pi, e)] \right]
$$
